 ...
 *
 */
@Component(value = "ordenadorBean")
public class Ordenador {

	/**
	 * Atributos
	 */
	//@Value("#{modelo.entidad.Ordenador.calcularPrecioComponentes()}")
	 ...
	 */
	@Autowired
	@Qualifier("procesadorBean")
	private Procesador procesador;
	@Autowired
	@Qualifier("placaBaseBean")
	...
	public Ordenador(double precio, String marca, ArrayList<Ram> ramListOrdenador,
			ArrayList<TarjetaGrafica> graficaListOrdenador, ArrayList<Periferico> perifListOrdenador,
			Procesador procesador, PlacaBase placaBase) {
		super();
		this.precio = precio;
		this.marca = marca;
	...
	public String toString() {
		return "Ordenador [precio=" + precio + ", marca=" + marca + ",\n \n ramList=" + ramListOrdenador
				+ ",\n \n graficaList=" + graficaListOrdenador + ", \n \n perifList=" + perifListOrdenador
